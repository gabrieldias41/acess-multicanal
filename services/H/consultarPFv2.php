...
<head>
	...
	<body onload="StartClean()">
	</body>

<script>
	function StartClean() {
		CleanObj("SimpleXMLElement Object");
		CleanObj("[\(\)]");
		CleanObj(" {2,5}");
		CleanObj("[=>]");
		CleanObj("Array");
	...
	function CleanObj(word) {
		var str = document.getElementById("tabela").innerHTML;		
		var regex;		
		regex = new RegExp(word, "g");
		var res = str.replace(regex, "");
		document.getElementById("tabela").innerHTML = res;
	}
	
	function CleanLinesOne(word) {
		var str = document.getElementById("tabela").innerHTML;		
		var regex;		
		regex = new RegExp(word, "g");
		var res = str.replace(regex, "\r\n");
